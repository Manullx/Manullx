# Olá, eu sou Emanuel Henkel Gonçalves 👋

### Desenvolvedor Full Stack | Engenheiro de Dados

Sou desenvolvedor de software com experiência na construção de aplicações escaláveis, APIs REST, pipelines de dados, integrações entre sistemas, automações e soluções com inteligência artificial.

Minhas principais tecnologias incluem **Python, Node.js, React, bancos de dados SQL e NoSQL e computação em nuvem**. Gosto de desenvolver soluções completas, com foco em desempenho, organização, manutenibilidade e necessidades reais do negócio.
...
- 🎓 Estudante de Engenharia da Computação na UniCuritiba
- 🐍 Experiência com Python e processamento de dados
- 🔗 Experiência com desenvolvimento de APIs REST e integração de sistemas
- 📊 Experiência com pipelines, análise e qualidade de dados
- 🤖 Interesse em inteligência artificial e aprendizado de máquina
- ☁️ Experiência com AWS, Azure, Oracle Cloud e Hostinger
- 📍 Curitiba, Paraná, Brasil
- 🌎 Português nativo | Inglês C1 | Alemão A1
